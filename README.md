...
- 휠 이미지가 input으로 들어오면 휠 내 볼트를 탐지하여 **볼트 이미지를 추출**하고, 추출된 이미지들을 분류 모델에 넣어 **정상/유실/파단/풀림**을 분류한다.  
  <img src="/docs/ai_process.png" width="400"/>

- **볼트 이상 진단 시스템 구성도**  
  <img src="/docs/systemArch_boltAnomaly.png" width="400"/>  
...
- **전이학습 시스템 구성도**  
  <img src="/docs/systemArch_transferLearning.png" width="400"/>  
  ①	전이학습 페이지로 이동한다.  
...
- **레포트 시스템 구성도**  
  <img src="/docs/systemArch_report.png" width="400"/>  
  ①	레포트 페이지로 이동한다.  
...
- **AI 분석 시스템 구성도**  
  <img src="/docs/systemArch_analysis.png" width="400"/>  
  ①	AI 분석 페이지로 이동한다.  
...
## 팀 소개
<img src="/docs/team.png" width="400"/>
