...
public enum ErrorCode {
    ...
    INVALID_OHT_SERIAL_NO(BAD_REQUEST,"유효하지 않은 OHT 시리얼 번호 입니다."),FILE_NOT_FOUND(BAD_REQUEST,"유효하지 파일 이름입니다.")
    ,JPA_NOT_FIND(INTERNAL_SERVER,"DB에서 조회되지 않습니다. 파라미터를 정확하게 입력하세요.")
    ;
