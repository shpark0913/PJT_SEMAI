...
public enum SuccessCode {
    ...
    ,READ_OHT(CREATED,"OHT 조회 성공"),CREATE_OHT(CREATED,"OHT 생성 성공"),READ_BOARD(SUCCESS,"대시보드 조회 성공"),READ_REPORT_LIST(SUCCESS,"보고서 조회 성공")
    ,READ_REPORT_DETAIL(SUCCESS,"보고서 상세 조회 성공")
