...
public enum SuccessCode {
     ...
     */
    // 회원
    READ_BOLT(SUCCESS, "볼트 조회 성공"),READ_IMG(SUCCESS,"이미지 조회 성공"),READ_OHT(CREATED,"OHT 조회 성공"),
    CREATE_OHT(CREATED,"OHT 생성 성공"),READ_BOARD(SUCCESS,"대시보드 조회 성공")
    ,REAT_BOARD_LIST(SUCCESS,"보고서 조회 성공");
