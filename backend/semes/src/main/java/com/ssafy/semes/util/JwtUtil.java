...
import com.ssafy.semes.exception.UnAuthorizedException;
...
public class JwtUtil  {
    ...
    private static final String SALT = "semesSecretssafySecretsemesSecret";
    private static final int ACCESS_TOKEN_EXPIRE_MINUTES = 30; // 분단위
    private static final int REFRESH_TOKEN_EXPIRE_MINUTES = 2; // 주단위

    public <T> String createAccessToken(String key, T data) {
        return create(key, data, "access-token", 1000 * 60 * 60 * 24*15);
     ...
     * value로 들어갈 subject값 expire : 토큰 유효기간 설정을 위한 값 jwt 토큰의 구성 :
